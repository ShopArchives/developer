    ...
    async function setModalv3InnerContent(tab) {
        ...
        if (tab === "account") {
            ...
            tabPageOutput.innerHTML = `
                ...
                <div class="modalv3-content-card-1">
                    <h2 class="modalv3-content-card-header">Pack Opening</h2>
